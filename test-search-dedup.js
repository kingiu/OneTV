...
async function testSearchWithDedup() {
  console.log('=== 测试搜索 API（带去重）===\n');
  ...
  // 搜索
  console.log('搜索 "危险关系 2026"...');
  const searchResponse = await fetch('http://192.168.100.101:3000/api/search?q=%E5%8D%B1%E9%99%A9%E5%85%B3%E7%B3%BB%202026', {
    headers
  });
...
testSearchWithDedup().catch(console.error);
